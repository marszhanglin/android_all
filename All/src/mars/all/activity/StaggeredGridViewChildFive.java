...
import com.daimajia.androidanimations.library.YoYo;
  ...
  */
public class StaggeredGridViewChildFive extends StaggeredGridViewActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        
        List<ItemDataAtMain> items = new ArrayList<ItemDataAtMain>();
        ItemDataAtMain item1 = new ItemDataAtMain("AMQ+MQTT 方式消息推送", new Date()); 
            ...
            public void onItemClick(StaggeredGridView parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 8:
                        ...
                        break;
                    case 10: 
                        AndroidAnnotationsTest_.intent(StaggeredGridViewChildFive.this)
                        .start();
                        break;
                    case 11:
