...
import mars.all.R.id;
import mars.all.R.layout;
import org.androidannotations.api.builder.ActivityIntentBuilder;
import org.androidannotations.api.view.HasViews;
import org.androidannotations.api.view.OnViewChangedListener;
import org.androidannotations.api.view.OnViewChangedNotifier;

public final class AndroidAnnotationsTest_
    extends AndroidAnnotationsTest
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.androidannotations_activity);
    }
    ...
    public static AndroidAnnotationsTest_.IntentBuilder_ intent(Context context) {
    ...
    public void onViewChanged(HasViews hasViews) {
        abcEt = ((EditText) hasViews.findViewById(id.ed_id));
        {
            View view = hasViews.findViewById(id.btn_id);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        AndroidAnnotationsTest_.this.myBtnclick();
                    }
